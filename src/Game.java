...
public class Game extends JPanel implements KeyListener{
	...
	private void shoot()
	{
		if(System.nanoTime() / 1000000 - timeSinceLastShot > 1000 / shootSpeed && player.getAim().size() > 1)
		{
	...
	{
		try {
			Thread.sleep(Math.max(0, 1000 / FPS - (System.nanoTime() / 1000000 - updateTime)));
		...
		while(scanner.hasNext())
		{
			...
			else if(next.equals("move"))
			{
				...
				while(!nextmove.equals("endmove"))
				{
					...
					if(nextmove.equals("up"))
						keys.add(new Key(KeyType.MOVE, scanner.next().charAt(0), Direction.NORTH));
					else if(nextmove.equals("down"))
						keys.add(new Key(KeyType.MOVE, scanner.next().charAt(0), Direction.SOUTH));
					else if(nextmove.equals("left"))
						keys.add(new Key(KeyType.MOVE, scanner.next().charAt(0), Direction.WEST));
					else if(nextmove.equals("right"))
						keys.add(new Key(KeyType.MOVE, scanner.next().charAt(0), Direction.EAST));
				}
			}
			else if(next.equals("aim"))
			{
				...
				while(!nextmove.equals("endaim"))
				{
					...
					if(nextmove.equals("up"))
						keys.add(new Key(KeyType.AIM, scanner.next().charAt(0), Direction.NORTH));
					else if(nextmove.equals("down"))
						keys.add(new Key(KeyType.AIM, scanner.next().charAt(0), Direction.SOUTH));
					else if(nextmove.equals("left"))
						keys.add(new Key(KeyType.AIM, scanner.next().charAt(0), Direction.WEST));
					else if(nextmove.equals("right"))
						keys.add(new Key(KeyType.AIM, scanner.next().charAt(0), Direction.EAST));
				}
			}
